        ...
        <div class="row align-items-start">
            <div class="col-1 background_logo">
                <a href="https://www.gamertotal.com.ar/" target="_self">
                    <img loading="eager" src="<?php echo get_template_directory_uri(); ?>/imagenes/logo.png" class="img-fluid mx-auto d-block" id="logo" alt="logo Gamer Total" cache-control="max-age=31536000" decoding="async">
                </a>
            </div>
                ...
                <nav class="navbar navbar-expand-lg d-none d-lg-block" style="padding: 0;">
                    <div class="container p-0" style="background-color: rgba(0, 0, 0, 0.65);">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0 raleway700" style="font-size: 15px; font-weight: normal; margin-left: 30px">
                            ...
                            <li class="nav-item" style="background-color: #fff; padding-left: 4px; padding-right: 5px; margin-left: 15px; width: 41px; height:40px;"><a class="nav-link" style="font-size: 16px;" href="/?s" target="_self" rel="nofollow" alt="Buscar"><i class="bi bi-search" style="color: #000;" aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </nav>
                <div id="progress2">
