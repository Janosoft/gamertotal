                ...
                <a href="<?php the_permalink(); ?>" alt="<?php the_title_attribute(); ?>">
                    <article itemscope itemtype="http://schema.org/BlogPosting">
                        <?php the_post_thumbnail('medium_large', ['title' => get_the_title(), 'alt' => implode(', ', array_map(function ($tag) {
                            return $tag->name;
                        }, get_the_tags())), 'loading' => 'eager', 'class' => 'img-fluid rounded-top-4 border border-white border-2 border-bottom-0 border-end-0']); ?>
                            ...
                            <a href="<?php the_permalink(); ?>" alt="<?php the_title_attribute(); ?>">
                                <div class="row">
                                    <div class="col-lg">
                                        <?php the_post_thumbnail('medium_large', ['title' => get_the_title(), 'alt' => implode(', ', array_map(function ($tag) {
                                            return $tag->name;
                                        }, get_the_tags())), 'loading' => 'eager', 'class' => 'img-fluid']); ?>
                                    </div>
                                    <div class="col-lg">
